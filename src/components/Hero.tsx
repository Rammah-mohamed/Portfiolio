...
>
  <section className="relative flex flex-2 flex-col items-center justify-center gap-4">
    ...
    <motion.p
      ...
      className="text-secondaryText mt-4 text-lg max-md:text-base max-sm:text-sm text-center max-w-2xl"
    >
      Self-taught Frontend Developer (React & TypeScript) specializing in
      <span className="text-primary font-semibold"> internal tools for B2B SaaS operations teams</span>.  
      I build dashboards and workflow apps that help companies cut costs, boost efficiency, and make smarter decisions.
    </motion.p>
